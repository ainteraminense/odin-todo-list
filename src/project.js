...
export function createProject(
  ...
  function getConvertedToDosFromDB() {
    ...
    unconvertedToDos.forEach((unconvertedToDos) => {
      ...
      const convertedToDo = createToDoItem(
        unconvertedToDos.title,
        unconvertedToDos.description,
        unconvertedToDos.dueDate,
        unconvertedToDos.priority,
        unconvertedToDos.projectId,
      );
