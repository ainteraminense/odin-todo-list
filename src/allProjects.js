...
export function allProjects() {
  ...
  function getConvertedProjectsFromDB() {
    ...
    unconvertedProjects.forEach((unconvertedProject) => {
      const convertedProject = createProject(
        unconvertedProject.name,
        unconvertedProject.isActive,
        unconvertedProject.projectId,
      );
